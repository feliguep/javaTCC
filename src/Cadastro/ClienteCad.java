 ...
 * @author Guedes
 */
public class ClienteCad extends CadastroBd {
    
    public static void incluirDados(model.ClienteMod cadastro_cliente) throws Exception {
        try {
    ...
    public static void alterarDados(model.ClienteMod cadastro_cliente) throws Exception {
        try {
    ...
    public static void excluirDados(model.ClienteMod cadastro_cliente) throws Exception {
        try {
